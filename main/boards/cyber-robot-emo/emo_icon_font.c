 ...
 * Size: 20 px
 * Bpp: 1
 * Opts: --bpp 1 --size 20 --no-compress --stride 1 --align 1 --font fontawesome-webfont.ttf --range 61744,61633,61480 --format lvgl -o EMO_ICON_FONT.c
 ******************************************************************************/
...
#ifndef ENABLE_EMO_ICON_FONT
#define ENABLE_EMO_ICON_FONT 1
#endif

#if ENABLE_EMO_ICON_FONT
...
#if LVGL_VERSION_MAJOR >= 8
static const lv_font_fmt_txt_dsc_t emo_icon_font_dsc = {
#else
static lv_font_fmt_txt_dsc_t emo_icon_font_dsc = {
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t EMO_ICON_FONT = {
#else
lv_font_t EMO_ICON_FONT = {
#endif
    .get_glyph_dsc = lv_font_get_glyph_dsc_fmt_txt, /*Function pointer to get glyph's data*/
    .get_glyph_bitmap = lv_font_get_bitmap_fmt_txt, /*Function pointer to get glyph's bitmap*/
    .line_height = 18,                              /*The maximum line height required by the font*/
    .base_line = 1,                                 /*Baseline measured from the bemom of the line*/
...
#endif
    .static_bitmap = 0,
    .dsc = &emo_icon_font_dsc, /*The custom font data. Will be accessed by `get_glyph_bitmap/dsc` */
